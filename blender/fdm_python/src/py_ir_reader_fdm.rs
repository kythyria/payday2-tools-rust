...
enum AnimItem<'a> {
    LinearFloat(&'a fdm::LinearFloatController),
    LinearVec3f(&'a fdm::LinearVector3Controller),
    LinearVec4f(&'a fdm::QuatLinearRotationController),
    Null,
    OOB
}
...
impl<'s, 'hi, 'py> IrReader<'s, 'hi, 'py> {
    ...
    fn import_animations(&self, obj: &fdm::Object3d, data: Py<ir::Object>) -> ConvResult<()> {
    ...
    fn import_object3d(&mut self, id: u32, sec: &fdm::Object3d) -> ConvResult<Py<ir::Object>> {
    ...
    fn import_model(&mut self, id: u32, md: &fdm::Model) -> ConvResult<Py<ir::Object>> {
...
fn merge_vertices(geo: &fdm::Geometry, units_per_cm: f32) -> VertexCache {
...
impl ToAnimation for fdm::LinearVector3Controller {
    fn to_animation(&self, py: Python, framerate: f32, path: &str, scale: f32) -> pyo3::PyResult<Vec<Py<ir::Animation>>> {
        let xa = ir::Animation {
...
impl ToAnimation for fdm::QuatLinearRotationController {
